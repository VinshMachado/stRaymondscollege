  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 overflow-hidden">
      ...
      <Card className="bg-white shadow-none border-0">
        <CardContent className="p-6 space-y-12 text-gray-800">
          ...
          <FadeUpSection>
            <section>
              ...
              <ul className="list-disc list-inside ml-4 mt-2">
                ...
                <li>EBAC (Economics, Business Studies, Accountancy, Computer Science)</li>
                <li>EBAS (Economics, Business Studies, Accountancy, Statistics)</li>
